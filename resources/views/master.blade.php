        ...
        <ul class="nav navbar-nav">
          <li class="dropdown active">
            ...
            <ul class="dropdown-menu" aria-labelledby="dLabel">
              ...
              <li class="divider"></li>
              <li><a href="{{url('Jadwal_Kuliah')}}">Jadwal Mahasiswa</a></li>              
            </ul>
          </li>
          <li class="dropdown active">
    ...
    <div class="container">
      ...
      <div class="container">
              <div class="content">
                  ...
                  Oktafira Anandiya / 1515015123</div>
                  </div>
                </div>
            <div>
      ...
      <nav class="navbar navbar-default navbar-fixed-bottom">
        <footer class="container">
          created by <a href="https://twitter.com/oktfranndiya"><span><i class="fa fa-twitter" style"color#1da1f2"></i>@oktfranndiya</span></a>
        </footer>
      </nav>
